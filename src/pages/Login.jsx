      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-white/50">
          <h1 className="text-2xl md:text-3xl font-bold text-center text-slate-800 mb-4">
            {hasFirebaseConfig ? "Anmelden" : mode === "login" ? "Login" : "Register"}
          </h1>

          {hasFirebaseConfig && (
            <p className="text-sm text-slate-600 text-center mb-6">
              Für dieselben Projekte in Chrome, Brave und auf allen Geräten: bitte mit Google anmelden
              (Cloud-Speicher). E-Mail-Login würde nur in diesem Browser speichern.
            </p>
          )}
          ...
          {hasFirebaseConfig && (
            <div className="flex flex-col items-center gap-3 mb-6">
              ...
              >
                ...
                {googleLoading ? "Bitte warten…" : "Mit Google anmelden"}
              </button>
              {error && (
                <p className="text-sm text-red-600 text-center bg-red-50 py-2 px-3 rounded-lg border border-red-100 w-full">
                  {error}
                </p>
              )}
            </div>

        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-white/50">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-[#1877F2] flex items-center justify-center text-white hover:opacity-90"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-[#1DA1F2] flex items-center justify-center text-white hover:opacity-90"
                aria-label="Twitter"
              >
